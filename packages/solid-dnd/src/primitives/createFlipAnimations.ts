...
export function runLayoutTransitionAnimations<K>(options: {
  ...
  const savedStyles = new Map<HTMLElement, InlineStyleSnapshot>();
...
function snapshotInlineStyles(element: HTMLElement, properties: ReadonlyArray<string>): InlineStyleSnapshot {
...
function restoreInlineStyles(element: HTMLElement, styles: InlineStyleSnapshot): void {
