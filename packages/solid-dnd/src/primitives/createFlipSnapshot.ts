...
import { calculateDeltas, measureElements } from './flipUtils';
...
export function createFlipSnapshot<K>() {
  ...
  return {
    captureFirst(elements: Map<K, HTMLElement>, container?: HTMLElement | null): void {
    ...
    captureLast(elements: Map<K, HTMLElement>): void {
